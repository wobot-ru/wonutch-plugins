...
public class TestFbService {
    ...
    public void check_that_request_and_parse_is_success_for_fb_user() throws IOException, URISyntaxException {
        ...
        ParseResult parse = new FbParser().parse(new URI("fb://1704938049732711?scope=user&comment_id=10154479526792506_10154481125912506"), content);
    ...
    public void check_that_request_get_friends_for_profile() throws IOException, URISyntaxException {
        ...
        String content = new String(request.getData(), StandardCharsets.UTF_8);
        ParseResult parse = new FbParser().parse(new URI("fb://mastercardrussia/friends"), content);
    ...
    public void request_should_get_and_parse_fb_posts_page() throws IOException, URISyntaxException {
        ...
        String content = new String(request.getData(), StandardCharsets.UTF_8);
        ParseResult parse = new FbParser().parse(new URI("fb://191234802505/index-posts/x100/00000000"), content);
    ...
    public void request_should_get_and_parse_fb_posts_page_with_no_likes() throws IOException, URISyntaxException {
        ...
        String content = new String(request.getData(), StandardCharsets.UTF_8);
        ParseResult parse = new FbParser().parse(new URI("fb://96814974590/index-posts/x100/1453725511"), content);
    ...
    public void check_that_request_get_and_parse_fb_comments_page() throws IOException, URISyntaxException {
        ...
        String content = new String(request.getData(), StandardCharsets.UTF_8);
        ParseResult parse = new FbParser().parse(new URI("fb://mastercardrussia/posts/165107853523677_1081856348515485/x100/0"), content);
    ...
    public void check_that_request_get_and_parse_fb_comments_page_for_status_posts() throws IOException, URISyntaxException {
        ...
        String content = new String(request.getData(), StandardCharsets.UTF_8);
        ParseResult parse = new FbParser().parse(new URI("fb://mastercardrussia/posts/165107853523677_992162300818224/x100/0"), content);
    ...
    public void check_that_request_get_and_parse_fb_comments_page_for_event_posts() throws IOException, URISyntaxException {
        ...
        String content = new String(request.getData(), StandardCharsets.UTF_8);
        ParseResult parse = new FbParser().parse(new URI("fb://23680604925/posts/23680604925_157764544592548/x100/0"), content);
    ...
    public void check_that_request_get_and_parse_fb_comments_page_for_video_posts() throws IOException, URISyntaxException {
        ...
        String content = new String(request.getData(), StandardCharsets.UTF_8);
        ParseResult parse = new FbParser().parse(new URI("fb://162280197182417/posts/162280197182417_769592706451160/x100/0"), content);
    ...
    public void check_that_request_get_and_parse_fb_comments_page_for_old_comments() throws IOException, URISyntaxException {
        ...
        String content = new String(request.getData(), StandardCharsets.UTF_8);
        ParseResult parse = new FbParser().parse(new URI("fb://162280197182417/posts/233436326701158:265932876784836:10102644640331371_10100522591459358/x100/0"), content);
