...
public class TestDomainService {
    ...
    public void is_indexPosts_for_private_profiles_should_throw_exception() throws IOException {
        Response request = new DomainService(new VKService()).request("http://id7076373/index-posts");
    ...
    public void is_indexPosts_for_durov_profile_should_return_response() throws IOException {
        Response request = new DomainService(new VKService()).request("http://durov/index-posts");
    ...
    public void check_that_request_and_parse_serialization_is_success_for_post() throws IOException {
        Response request = new DomainService(new VKService()).request("http://durov/posts/145488");
        ParseResult parse = Parser.parse("http://durov/posts/145488", request.data);
